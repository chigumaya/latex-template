...
\ifdefined\PRINT
  \documentclass[book,
    fontsize=9pt, paper=a5paper, line_length=37zw, openany, hanging_punctuation,
  ...
  \AddToShipoutPictureFG{%
    ...
    \ifodd\value{page}% 奇数ページ(右ページ)
      \put(
        ...
        \colorbox{white}{\verticaltext[3pt]{\theCurrentPage}}%
      }%
    \else% 偶数ページ(左ページ)
      \put(
        \ptlen\dimexpr 1in+\paperwidth-1mm-3pt\relax,% ノド(右)から1mm+ノンブル幅だけ内側
...
\ModifyHeading{section}{
  ...
  format={%
    ...
    \begin{picture}(0,0)
      \put(0,-5){%
        \begin{tikzpicture}
          \fill[darkgray] (0pt,0pt) rectangle (5pt,19pt);
        \end{tikzpicture}
      }
      \put(0,-5){%
        \color{darkgray}
...
\ModifyHeading{subsection}{
  ...
  format={%
    \noindent #1#2\par\nobreak
    \vskip2pt
    {\color{darkgray}\hrule height 0.6pt depth0pt width\hsize}%
  }%
}
